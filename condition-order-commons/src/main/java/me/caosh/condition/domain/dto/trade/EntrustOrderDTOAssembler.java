...
public class EntrustOrderDTOAssembler {
    public static EntrustOrderDTO toDTO(EntrustOrder entrustOrder) {
        ...
        entrustOrderDTO.setUserId(entrustOrder.getEntrustCommand().getCustomerIdentity().getUserId());
        entrustOrderDTO.setCustomerNo(entrustOrder.getEntrustCommand().getCustomerIdentity().getCustomerNo());
